...
async function authenticateLocal(email, password) {
    const normalizedEmail = email.trim().toLowerCase();
    const storedUserOk = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2f$local$2d$user$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyStoredLocalUser"])(normalizedEmail, password);
    if (!storedUserOk) {
