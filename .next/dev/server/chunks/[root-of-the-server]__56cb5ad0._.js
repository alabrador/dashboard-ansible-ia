...
;
function buildTip(weatherCode, rainProbability, maxTemp) {
    const isRainLikely = rainProbability >= 45 || [
        51,
        53,
        55,
        61,
    ...
    const isSunny = [
        0,
        1
    ].includes(weatherCode) && rainProbability < 30;
    if (isRainLikely) {
...
async function GET() {
    ...
    try {
        ...
        if (weatherCode === undefined || rainProbability === undefined || maxTemp === undefined) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Datos de clima incompletos."
            }, {
                status: 502
            });
        }
